  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center">
      <div className="w-20 h-20 rounded-3xl bg-accent-primary/10 border border-accent-primary/20 flex items-center justify-center">
        <Repeat2 size={40} className="text-accent-primary" />
      </div>
      <div className="space-y-2">
        <h1 className="text-2xl font-black uppercase tracking-tight text-foreground">Gastos Fijos</h1>
      ...
      <p className="text-sm text-foreground/50 max-w-xs font-medium">
        Gestiona los gastos recurrentes y fijos de tu operación.
      </p>
      <Link
