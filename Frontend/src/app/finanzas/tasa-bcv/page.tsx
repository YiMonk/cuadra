  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-black uppercase tracking-tight text-foreground">Tasa BCV</h1>
      ...
      <p className="text-sm text-foreground/50 max-w-xs font-medium">
        Consulta y gestiona la tasa oficial del Banco Central de Venezuela.
      </p>
      <Link
