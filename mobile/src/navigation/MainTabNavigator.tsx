...
export default function MainTabNavigator() {
    ...
    return (
        <Tab.Navigator
            initialRouteName={isAdminGod ? "AdminDashboard" : "POS"}
            screenOptions={{
                headerShown: false,
            }}
        ...
        >
            {isAdminGod ? (
                <>
                    <Tab.Screen
                        name="AdminDashboard"
                        component={AdminGodDashboardScreen as any}
                        options={{
                            tabBarLabel: 'Control',
                            tabBarIcon: (props: any) => <MaterialCommunityIcons name="shield-crown" {...props} />,
                        }}
                    />
                    <Tab.Screen
                        name="AdminUserManagement"
                        component={AdminUserManagementScreen as any}
                        options={{
                            tabBarLabel: 'Usuarios',
                            tabBarIcon: (props: any) => <MaterialCommunityIcons name="account-search" {...props} />,
                        }}
                    />
                </>
            ) : (
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarLabel: 'Menú',
                    tabBarIcon: (props: any) => <MaterialCommunityIcons name="grid" {...props} />,
                }}
            />
        </Tab.Navigator>
    );
