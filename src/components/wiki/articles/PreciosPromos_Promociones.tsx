  ...
  return (
    <>
      <p className="text-lg text-slate-700 dark:text-slate-300 mb-6">
        Aprende sobre Promociones en Cuadra y cómo usarlo en tu negocio.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Esta guía te enseña a usar promociones de forma eficiente en Cuadra.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Promociones es una característica importante que te permite gestionar mejor tu negocio.
      </p>
      ...
      <Step number={2} title="Busca la opción">
        Encuentra la opción para promociones en la pantalla.
      </Step>
      ...
      <p className="text-slate-700 dark:text-slate-300">
        No hay limitaciones prácticas para usar promociones en Cuadra.
      </p>
    </>
  );
}
