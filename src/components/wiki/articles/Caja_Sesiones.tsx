  ...
  return (
    <>
      <p className="text-lg text-slate-700 dark:text-slate-300 mb-6">
        Aprende sobre Sesiones de Caja en Cuadra y cómo usarlo en tu negocio.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Esta guía te enseña a usar sesiones de caja de forma eficiente en Cuadra.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Sesiones de Caja es una característica importante que te permite gestionar mejor tu negocio.
      </p>
      ...
      <Step number={2} title="Busca la opción">
        Encuentra la opción para sesiones de caja en la pantalla.
      </Step>
      ...
      <p className="text-slate-700 dark:text-slate-300">
        No hay limitaciones prácticas para usar sesiones de caja en Cuadra.
      </p>
    </>
  );
}
