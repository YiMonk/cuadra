  ...
  return (
    <>
      <p className="text-lg text-slate-700 dark:text-slate-300 mb-6">
        Aprende sobre Historial en Cuadra y cómo usarlo en tu negocio.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Esta guía te enseña a usar historial de forma eficiente en Cuadra.
      </p>
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-4">
        Historial es una característica importante que te permite gestionar mejor tu negocio.
      </p>
      ...
      <Step number={2} title="Busca la opción">
        Encuentra la opción para historial en la pantalla.
      </Step>
      ...
      <p className="text-slate-700 dark:text-slate-300">
        No hay limitaciones prácticas para usar historial en Cuadra.
      </p>
    </>
  );
}
